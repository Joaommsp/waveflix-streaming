...
import signin_banner from "../../assets/images/signin-banner.png";
...
const Signin = () => {
  return (
    <div className="w-ful h-fit flex laptop:flex-row tablet:flex-col justify-center align-top laptop:p-4 min-h-screen">
      <div
        style={{
          backgroundImage: `url(${signin_banner})`,
      ...
      <div className="relative laptop:w-3/ w-full 4 h-full tablet:bg-signin-banner laptop:bg-none bg-cover min-h-screen bg-no-repeat tablet:flex laptop:rounded-3xl tablet:justify-center tablet:items-center tablet:py-24 laptop:py-16">
        <div
        ...
        >
          ...
          <form className="tablet:w-8/12 w-full flex flex-col items-center gap-3">
            ...
            <input
              ...
              className="w-full text-sm text-gray-100 py-4 px-2 border bg-transparent outline-none border-gray-100 rounded-md tablet:w-96 focus:border-blue-500 hover:border-gray-500 transition ease-in-out hover:cursor-pointer focus:cursor-tex focus:placeholder-gray-50t"
              type="password"
            />
